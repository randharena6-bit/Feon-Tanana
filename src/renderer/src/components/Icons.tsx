...
export function IconHand(props: IconProps): React.JSX.Element {
  return (
    <Svg {...props}>
...
export function IconVolume(props: IconProps): React.JSX.Element {
  return (
    <Svg {...props}>
...
export function IconRecord(props: IconProps): React.JSX.Element {
  return (
    <Svg {...props}>
